...
void CreateTriangleData()
{
	...
	TriangleVertex triangleVertices[42] =
	{
		...
		//ground Orange
		// pos                color               texture coordinates for each vertex
		{ 3.0f,  -1.0f,  3.0f,    1.0f, 0.5f, 0.0f,   1.0f, 1.0f, 2.0f },  //4
		{  3.0f,  -1.0f, -3.0f,   1.0f, 0.5f, 0.0f,   1.0f, 0.0f, 2.0f }, //8
		{ -3.0f,  -1.0f, -3.0f,   1.0f, 0.5f, 0.0f,   0.0f, 0.0f, 2.0f }, //7

		{ -3.0f, -1.0f,   3.0f,  1.0f, 0.5f, 0.0f,  0.0f, 1.0f, 2.0f },  //3
		{  3.0f, -1.0f,   3.0f,  1.0f, 0.5f, 0.0f,  1.0f, 1.0f, 2.0f },  //4
		{ -3.0f, -1.0f,  -3.0f,  1.0f, 0.5f, 0.0f,  0.0f, 0.0f, 2.0f },  //7
